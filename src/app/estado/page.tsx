...
export default function EstadoPage() {
  return (
    <main className="max-w-3xl mx-auto p-8" data-oid="tysooj_">
      <h1 className="text-3xl font-bold mb-2 text-amber-700" data-oid="h1v:4bv">
        Estado del sistema
      </h1>
      <p className="text-zinc-600 mb-4" data-oid=".3teljb">
