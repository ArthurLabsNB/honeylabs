...
export default function TabBar() {
  ...
  return (
    <div
      className="fixed z-20 w-full overflow-x-auto overflow-y-hidden whitespace-nowrap border-b-2 border-[var(--dashboard-border)] bg-[color:var(--dashboard-card)/0.8] backdrop-blur-sm shadow transition-all"
