    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        >
          ...
          <Link href="/docs" className="hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500">
            Documentación
          </Link>
          <Link href="/ayuda" className="hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500">
            Soporte
          </Link>
          <Link href="/contacto" className="hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500">
            Contacto
          </Link>
          <Link href="https://github.com/LabGestor/honeylabs" className="hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500" target="_blank" rel="noopener noreferrer">
            GitHub
          </Link>
          <Link href="/estado" className="hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500">
            Estado del sistema
          </Link>
          {/* LEGAL DROPDOWN */}
